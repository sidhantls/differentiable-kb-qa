...
def create_differentiable_kg(triplets, entity_to_idx, rel_to_idx):
    ...
    Ms = create_sparse_tensor(entity_to_idx, triplets, name='head')
    Mr = create_sparse_tensor(rel_to_idx, triplets, name='relation')
    Mo = create_sparse_tensor(entity_to_idx, triplets, name='tail')
